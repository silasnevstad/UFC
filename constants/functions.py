...
determine_search_term = {
    ...
    "description": "Extracts specific seacrh term (that can be used to query evidence) and genre from a claim.",
    "parameters": {
        "type": "object",
        "properties": {
            "claim": {
            ...
            "genre": {
                "type": "string",
                "description": "Claim genre (strictly either history, science, politics or current events).",
            },
        },
